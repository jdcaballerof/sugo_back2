...
import { deleteCumplimiento, example, getAllCumpli, getCumpli, postCumpli, repGeneral } from '../controllers/cumpli.controllers.js';
...
router.get( "/api/mod:mod", repGeneral);
